...
public class jFConexao extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sgfi.SGFIApp.class).getContext().getResourceMap(jFConexao.class);
    ...
    private void okjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okjButtonActionPerformed
        ...
        ClassConecta.url                = "jdbc:mysql://"+ prefs.get("localhost", null) +":"+ prefs.get("3306", null) +"/"+prefs.get("cadma", null);
